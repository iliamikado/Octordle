...
export const InfoPage = () => {
    ...
    return <div className={styles.page}>
        ...
        <div className={styles.block}>
            ...
            В конце игры вы увидете попытки, потраченные на отгадывание слов и общий счет.<br/>
            Попытки отображаются в виде цифр (от 1 до 10) и часов (от 11 до 14). Например 11 будет отображаться как 11 часов 🕚<br/> 
