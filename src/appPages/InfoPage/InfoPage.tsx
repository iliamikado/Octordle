...
export const InfoPage = () => {
    ...
    return <div className={styles.page}>
        ...
        <div className={styles.block}>
            ...
            Розовый цвет означает, что введеное слово сложное, и оно точно не было загадано, однако его можно использовать для разгадывания. По умолчанию это подсвечивание выключено. Включить функцию можно в настройках
        </div>
        <div className={styles.block}>
